    ...
    <div className="selectedPost">
      ...
      {userInfo.id === postInfo.author._id && (
        <div className="edit-row">
            <div className='authorChoiceBtn'>
                <Link className="editPostButton" to={`/post/edit/${postInfo._id}`}>
      ...
      <div className='edit-row'>
            <button className="deletePostButton" onClick={deletePost}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-51 1.5 125 22" strokeWidth={1.5} stroke="currentColor" className="w-6-h-6">
